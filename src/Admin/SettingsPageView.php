<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row">Antibot Salt</th>
                <td><input type="text" name="<?php echo \Hyperion\RestAPI\Plugin::API_ANTIBOT_SALT_OPTION; ?>" value="<?php echo esc_attr( get_option(\Hyperion\RestAPI\Plugin::API_ANTIBOT_SALT_OPTION) ); ?>" /></td>
            </tr>
        </table>
